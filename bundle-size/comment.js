...
function getPrMessageTitle(workingDirectory) {
  ...
  const shouldNotPrintSubdirectory =
    workingDirectory == null ||
    workingDirectory === "." ||
    workingDirectory === "./";
  return shouldNotPrintSubdirectory ? base : `${base} - ${workingDirectory}`;
}
...
function getBelowThresholdComment(diffPercentage, diffThreshold) {
  return `${prMessageSymbol}
${prMessageWelcome}
